        ...
        <table role="presentation" cellpadding="0" cellspacing="0" width="600" style="max-width: 600px; background-color: #ffffff; border-radius: 8px; overflow: hidden;">
          ...
          <tr>
            <td align="center" style="padding: 0 40px 16px 40px;">
              <h1 style="margin: 0; font-size: 22px; font-weight: 600; color: #172033;">Ação necessária</h1>
            </td>
          </tr>
          <!-- Body -->
          <tr>
            <td style="padding: 0 40px 24px 40px;">
              ...
              <p style="margin: 0 0 16px 0; font-size: 15px; line-height: 1.6; color: #374151;">
                Existe uma ação pendente na sua conta DescontoVivo. Clique no botão abaixo para realizá-la:
              </p>
              <#if requiredActions??>
              <p style="margin: 0 0 16px 0; font-size: 14px; line-height: 1.6; color: #6b7280;">
                Ações requeridas: <#list requiredActions as action>${action}<#if action_has_next>, </#if></#list>
              </p>
              </#if>
            </td>
          </tr>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="background-color: #172033; border-radius: 6px;">
                    <a href="${link}" target="_blank" style="display: inline-block; padding: 14px 32px; font-size: 15px; font-weight: 600; color: #ffffff; text-decoration: none; border-radius: 6px;">Realizar ação</a>
                  </td>
                </tr>
              </table>
            </td>
