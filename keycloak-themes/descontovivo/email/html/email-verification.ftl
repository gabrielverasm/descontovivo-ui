        ...
        <table role="presentation" cellpadding="0" cellspacing="0" width="600" style="max-width: 600px; background-color: #ffffff; border-radius: 8px; overflow: hidden;">
          ...
          <tr>
            <td align="center" style="padding: 0 40px 16px 40px;">
              <h1 style="margin: 0; font-size: 22px; font-weight: 600; color: #172033;">Verifique seu e-mail</h1>
            </td>
          </tr>
          <!-- Body -->
          <tr>
            <td style="padding: 0 40px 24px 40px;">
              ...
              <p style="margin: 0 0 16px 0; font-size: 15px; line-height: 1.6; color: #374151;">
                Confirme seu endereço de e-mail para ativar sua conta no DescontoVivo. Clique no botão abaixo para verificar:
              </p>
            </td>
          </tr>
          <!-- CTA Button -->
              ...
              <table role="presentation" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="background-color: #172033; border-radius: 6px;">
                    <a href="${link}" target="_blank" style="display: inline-block; padding: 14px 32px; font-size: 15px; font-weight: 600; color: #ffffff; text-decoration: none; border-radius: 6px;">Verificar e-mail</a>
                  </td>
                </tr>
              </table>
            </td>
